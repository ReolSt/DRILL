...
class IdleState:
    ...
    def do(boy):
        ...
        if boy.attached is not None:
            boy.x += boy.attached.speed * game_framework.frame_time

            attached_bb = boy.attached.get_bb()
            boy.x = clamp(attached_bb[0], boy.x, attached_bb[2])
